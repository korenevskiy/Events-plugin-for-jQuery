...
function m(a){let b=arguments[1],c=arguments[2],e={id:b,onlyone:!1,name:a,property:void 0,elements:this,tagListItem:"div",classListItem:"",unbind:function(e){if(0===arguments.length)return delete g[a][aselector],this.onlyone=!0,this;if(["1",1,!0].includes(e))return delete g[a][b],this.onlyone=!0,this;this.onlyone=!1;return this}},f;if(0===arguments.length||["undefined",void 0,null].includes(a))return g;if(1===arguments.length){if(["handler","function"].includes(arguments[0]))return p=arguments[0],
...
g.hasOwnProperty(a)&&(g[a]={});0===c&&(c=Object.keys(g[a]).length+1,c=v.concat(c));"undefined"===typeof b||[!1,null,"undefined",void 0].includes(b)?delete g[a][c]:g[a][c]=b};h.fn.event=m;jQuery.fn.var=function(a,b){if(0===arguments.length)return k;if(1===arguments.length)return!1===k.hasOwnProperty(a)?null:k[a];if(2===arguments.length){[void 0,null].includes(b)?delete k[a]:k[a]=b;if(void 0===g[a])return g[a]={},this;for(var c in g[a]){var e=g[a][c].call(b,b,{value:b,property:void 0,propsRequaire:[],
object:b,id:c});[!1,null].includes(e)&&delete g[a][c]}}if(3===arguments.length){c=arguments[2];["undefined",void 0,null,!1,"",0].includes(k[a])&&(k[a]={});if(["object"].includes(typeof c)){[void 0,null].includes(b)?delete k[a]:k[a]=b;if(void 0===g[a])return g[a]={},this;for(let d in g[a])e=g[a][d].call(b,b,{value:b,property:void 0,propsRequaire:[],object:b,id:d},c),[!1,null].includes(e)&&delete g[a][d];if(void 0===c.property)return this;c=c.property}if(!1===["+",null,!1,!0,!1,null,"+","-",""].includes(c)){k[a][c]=
b;var f=Object.keys(k[a]);isFinite(c)?f.sort((a,b)=>a-b):f.sort();Object.values(k[a]);f=[];for(var d in k[a])k[a][d]===b&&f.push(d);for(const [e,h]of Object.entries(g[a]))d=h.call(b,b,{value:b,property:c,propsRequaire:f,object:k[a],id:e}),[!1,null].includes(d)&&delete g[a][c];[null,void 0].includes(b)&&delete g[a][c];return this}if(["+",!0].includes(c)){var h=d=0;c=!0;if(Array.isArray(k[a]))d=k[a].length-1,k[a].push(b);else if(k[a]){for(var m of Object.keys(k[a]).sort((a,b)=>b-a))if(isFinite(m)){d=
m=parseInt(m);h=1+m;break}k[a][h]=b}m=[];for(f in k[a])k[a][f]===b&&m.push(f);for(const [e,h]of Object.entries(g[a]))f=h.call(b,b,{value:b,property:c,propsRequaire:m,prevProp:d,object:k[a],id:e}),[!1,null].includes(f)&&delete g[a][c];return this}if([null,!1,"-"].includes(c)){c=!1;f=[];for(h in k[a])k[a][h]===b&&(f.push(h),delete k[a][h]);for(const [e,h]of Object.entries(g[a]))d=h.call(b,b,{value:b,property:c,propsRequaire:f,object:k[a],id:e}),[!1,null].includes(d)&&delete g[a][c]}return this}};jQuery.fn.e=
jQuery().event;jQuery.fn.v=jQuery().var;jQuery.v=jQuery().var;jQuery.e=jQuery().event});
