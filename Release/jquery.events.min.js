...
function l(a){let b=arguments[1],c=arguments[2],e={id:b,onlyone:!1,name:a,property:void 0,elements:this,tagListItem:"div",classListItem:"",unbind:function(c){if(0===arguments.length)return delete g[a][aselector],this.onlyone=!0,this;if(["1",1,!0].includes(c))return delete g[a][b],this.onlyone=!0,this;this.onlyone=!1;return this}},f;if(0===arguments.length||["undefined",void 0,null].includes(a))return g;if(1===arguments.length){if(["handler","function"].includes(arguments[0]))return p=arguments[0],
g;if("string"===typeof a)return g[a];Array.isArray(a);if("object"===typeof a){for(var d in a)if("string"===typeof a[d])l.call(this,d,a[d]);else if("undefined"===typeof a[d]||["undefined",void 0,null].includes(a[d]))l.call(this,d,null);else if("function"===typeof a[d])l.call(this,d,a[d]);else if("object"===typeof a[d])for(let b in a[d])l.call(this,d,b,a[d][b]);else l.call(this,d,a[d]);return this}}if(2===arguments.length){if(["undefined",void 0,null].includes(b))return delete g[a],this;if("object"===
typeof b&&!(b instanceof HTMLElement)){d=arguments[1];for(let b in d)["string"].includes(typeof d[b])?Array.isArray(arguments[1])?l.call(this,a,d[b]):l.call(this,a,b,d[b]):["undefined",void 0,null].includes(d[b])?l.call(this,a,b,null):"function"===typeof d[b]?Array.isArray(arguments[1])?l.call(this,a,d[b]):l.call(this,a,b,d[b]):l.call(this,a,d[b]);return this}if(["string"].includes(typeof b)||b instanceof HTMLElement)f=function(c,...d){d=Object.assign({},e,{value:c},...d);return q(b,c,a,d,this)};
["function","handler"].includes(typeof b)&&(f=function(a,...c){c=Object.assign({},e,{value:a},...c);return b(a,c)});r(a,f);return this}if(3===arguments.length){if(["function","handler"].includes(typeof c))return[void 0,null,!1,"",0].includes(b)&&(e.onlyone=!0),f=arguments[2],f=function(c,...d){d=Object.assign({},e,{value:c},...d);let m=f.call(c,c,d);"String"===typeof m&&(m=p(m,c));m&&b&&(m=p(m,c),m=q(b,m,a,d,m));return!0===d.onlyone?!1:m},r(a,f,b,e),this;if([null,""].includes(b))return this;if(["undefined",
void 0,null,!1,0,""].includes(c)){if(b instanceof HTMLElement){for(let c in g[a])g[a][c]===b&&delete g[a][c];return this}["string","number"].includes(typeof b)&&""!==b&&delete g[a][b];return this}if("string"===typeof c&&("string"===typeof b||b instanceof HTMLElement))return f=function(d,...f){f=Object.assign({},e,{value:d},...f);let m=this;c&&(m=p(c,this));m=q(b,d,a,f,m);return!0===f.onlyone?!1:m},r(a,f,b),this;if(["object"].includes(typeof c)){let d=c;f=function(f,...m){m=Object.assign({},e,{value:f},
...m,d);c=m.format||"";let g=this;c&&(g=p(c,this));g=q(b,f,a,m,g);return!0===m.onlyone?!1:g};r(a,f,b);return this}}}function p(a,b,c){if("object"!==typeof b)return a=a.replace("{0}",b).replace("{this}",b).replace("{value}",b).replace("{val}",b),a=a.replace("{var}",b).replace("{variable}",b);for(let c in b)this[c]=b[c],a=a.replace("{"+c+"}",b[c]).replace("{this."+c+"}",b[c]).replace("{value."+c+"}",b[c]);return a}const v="".concat((new Date).valueOf().toString()),g={},k={},r=function(a,b,c=0,e){!1===
g.hasOwnProperty(a)&&(g[a]={});0===c&&(c=Object.keys(g[a]).length+1,c=v.concat(c));"undefined"===typeof b||[!1,null,"undefined",void 0].includes(b)?delete g[a][c]:g[a][c]=b};h.fn.event=l;jQuery.fn.var=function(a,b){if(0===arguments.length)return k;if(1===arguments.length){if(["string","number","boolean","bigint","symbol"].includes(typeof a)){if([void 0,null].includes(k[a]))return null;k[a]}if("object"===typeof a)for(var c in a){null===a[c]&&delete k[c];k[c]=a[c];for(var e in g[c]){var f=g[c][e].call(b,
...
propsRequaire:f,object:k[a],id:e}),[!1,null].includes(d)&&delete g[a][c];[null,void 0].includes(b)&&delete g[a][c];return this}if(["+",!0].includes(c)){var h=d=0;c=!0;if(Array.isArray(k[a]))d=k[a].length-1,k[a].push(b);else if(k[a]){for(var l of Object.keys(k[a]).sort((a,b)=>b-a))if(isFinite(l)){d=l=parseInt(l);h=1+l;break}k[a][h]=b}l=[];for(f in k[a])k[a][f]===b&&l.push(f);for(const [e,h]of Object.entries(g[a]))f=h.call(b,b,{value:b,property:c,propsRequaire:l,prevProp:d,object:k[a],id:e}),[!1,null].includes(f)&&
delete g[a][c];return this}if([null,!1,"-"].includes(c)){c=!1;f=[];for(h in k[a])k[a][h]===b&&(f.push(h),delete k[a][h]);for(const [e,h]of Object.entries(g[a]))d=h.call(b,b,{value:b,property:c,propsRequaire:f,object:k[a],id:e}),[!1,null].includes(d)&&delete g[a][c]}return this}};jQuery.fn.e=jQuery().event;jQuery.fn.v=jQuery().var;jQuery.v=jQuery().var;jQuery.e=jQuery().event;(function(){h("[events-var],[events-load]").each(function(){let a=this.attr("events-var"),b=this.attr("events-format"),c=this.attr("events-load");
a&&(b?l(a,this,b):l(a,this));c&&"undefined"!==(new Function("return typeof "+c))()&&eval(c+"(this)")})})()});
